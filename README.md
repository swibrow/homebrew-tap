...
| [agent-ops](https://github.com/swibrow/agent-ops) | TUI for monitoring and resuming Claude Code agent sessions in tmux | 0.2.0 | `brew install swibrow/tap/agent-ops` |
